...
public class SsoRedisService {
    ...
    @Autowired
    @Qualifier("ssoStringRedisTemplate")
    ...
    public Integer getInt(String key) {
        String value = stringRedisTemplate.boundValueOps(key).get().toString();
    ...
    public String getStr(String key) {
        if (stringRedisTemplate.boundValueOps(key).get() != null) {
            return stringRedisTemplate.boundValueOps(key).get().toString();
        }
        return null;
    }
    ...
    public <T> T getJson(String key, Class<T> clazz) {
        return JsonMapper.fromJsonString(stringRedisTemplate.boundValueOps(key).get().toString(), clazz);
    }
    ...
    public void set(String key, Object value) {
        set(key, value, new ExpireTime(-1));
    ...
    public void setJsonField(String key, String field, String value) {
        JSONObject obj = JSON.parseObject(stringRedisTemplate.boundValueOps(key).get().toString());
        obj.put(field, value);
